...
if ( ! class_exists( 'Shopay_Settings' ) ) :
	...
	?>
			<div id="mt-theme-message" class="updated notice shopay-message">
				...
				<div class="submit">
					<button class="mt-get-started button button-primary button-hero" data-done="<?php esc_attr_e( 'Done!', 'shopay' ); ?>" data-process="<?php esc_attr_e( 'Processing', 'shopay' ); ?>" data-redirect="<?php echo esc_url( wp_nonce_url( add_query_arg( 'shopay-hide-notice', 'welcome', admin_url( 'themes.php' ).'?page=shopay-settings&tab=demos' ) , 'shopay_hide_notices_nonce', '_shopay_notice_nonce' ) ); ?>">
			...
			<div class="wrap about-wrap">
				...
				<?php $this->intro(); ?>
					<div class="mt-nav-content-wrap">
						...
						?>
								<span class="configure-msg"><?php esc_html_e( 'No demos are configured for this theme, please contact the theme author', 'shopay' ); ?></span>
						<?php
							} else {
							?>
