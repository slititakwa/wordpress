	...
	*/
	public function site_footer_info (){
		...
		$html = '<div class="container site_info"><span class="back-to-top" id="backToTop"><i class="icofont-rounded-up parallax"></i></span>
			...
			$html  .= '<span class="dev_info">'.sprintf( esc_html__( 'Theme : %1$s By aThemeArt - Proudly Powered by WordPress .', 'fastest-shop' ), '<a href="'. esc_url( 'https://www.athemeart.com/downloads/fastest-shop/' ) .'" target="_blank" rel="nofollow">'.esc_html_x( 'Fastest Shop', 'credit - theme', 'fastest-shop' ).'</a>' ).'</span>';
