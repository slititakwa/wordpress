 ...
 *
 */
$shopay_top_header_option = get_theme_mod( 'shopay_top_header_option' );
...
<div id="site-top-header">
    <div class="mt-container">
        <div class="site-top header-wrap clearfix">
            <?php
                $shopay_top_header_description = get_theme_mod( 'shopay_top_header_description' );
            ...
            <div class="top-header-elements-wrap clearfix">
                <?php
                    $shopay_top_header_location = get_theme_mod( 'shopay_top_header_location' );
                    ...
                    $shopay_top_header_service = get_theme_mod( 'shopay_top_header_service' );
