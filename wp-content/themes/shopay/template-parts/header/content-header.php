    ...
    <div class="mt-container">
        <div class="main-header-wrapper clearfix">
            ...
            <nav id="site-navigation" class="main-navigation clearfix">
                <button class="menu-toggle mt-modal-toggler" data-popup-content=".primary-menu-wrap" aria-controls="primary-menu" aria-expanded="false"><i class="fas fa-ellipsis-v"></i><?php esc_html_e( 'MENU', 'shopay' ); ?></button>
            ...
            <?php
                $shopay_site_info_option = get_theme_mod( 'shopay_site_info_option', false );
        ...
        <div class="search-bar-section-wrapper clearfix">
            ...
            ?>
                            <h2 class="main-category-list-title cover-font">
                                ...
                                <button class="mt-modal-toggler" data-popup-content=".shopay-cat-menu"><i class="fas fa-bars"></i></button>
                            </h2>
            <?php
                        }
                        echo '<div class="shopay-cat-menu deactivate-menu mt-modal-popup-content">';
                            echo '<button class="mt-modal-close" data-focus=".main-category-list-title .mt-modal-toggler"><i class="far fa-window-close"></i></button>';
